...
<head>
    ...
    <link rel="icon" type="image/png" href="assets/images/icones/favicon.png" />
...
<header>
    ...
    <div class="middle-header">
        <div class="logo-header">
            <a href="index.php"><img src="assets/images/icones/logo.svg" alt="" class="logo"></a>
        </div>
    </div>
        ...
        <div class="container head menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <?php endif; ?>
                        <li class="nav-item"><a class="nav-links" href="#">Couture</a></li>
                        <li class="nav-item"><a class="nav-links" href="#">Tricot</a></li>
                        <li class="nav-item"><a class="nav-links" href="#">Crochet</a></li>
                        <li class="nav-item"><a class="nav-links" href="#">Côté enfant</a></li>
